...
ShapeExporter = JClass('com.jpexs.decompiler.flash.exporters.ShapeExporter')
SpriteExportMode = JClass('com.jpexs.decompiler.flash.exporters.modes.SpriteExportMode')
ShapeExportMode = JClass('com.jpexs.decompiler.flash.exporters.modes.ShapeExportMode')
ShapeExportSettings = JClass('com.jpexs.decompiler.flash.exporters.settings.ShapeExportSettings')
